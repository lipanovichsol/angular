...
export class ProfesorComponent{
    ...
    constructor(
        ...
        private _route: ActivatedRoute, private _router: Router){ //todo lo que escribo en el constructor se ejecuta primero cuando cargo un componente
        this.nombre='Profe';
        this.edad= 23;
        this.casado=true;
    ...
    ngOnInit(): void {
        ...
        this._route.params.forEach((params: Params) => {this.parametro = params['cantidad']; });
    }
